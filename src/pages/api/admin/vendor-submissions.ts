...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    console.log('API - Vendor submissions data:', submissions);
    console.log('API - Vendor submissions error:', submissionsError);
    ...
    console.error('Error in vendor-submissions API:', error);
    return res.status(500).json({ 
